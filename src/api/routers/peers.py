...
def compare_with_peers(
    ...
    peer_members = peer_groups[
        peer_groups["peer_group_name"] == group_name
    ]["company_id"]

    ratios = latest_ratios[
        latest_ratios["company_id"].isin(peer_members)
    ]
    ...
    benchmark_company = ratios[
        ratios["company_id"] == benchmark
    ]
